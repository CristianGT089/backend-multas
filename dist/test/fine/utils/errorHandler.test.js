...
import { globalErrorHandler, AppError } from '../../../src/fine/utils/errorHandler.js';
describe('Error Handler Utils', () => {
    ...
    describe('globalErrorHandler', () => {
        ...
        it('debe manejar errores de blockchain correctamente', () => {
            const error = new Error('Error de blockchain');
        ...
        it('debe manejar errores de gas impredecible', () => {
            const error = new Error('Error de gas');
        ...
        it('debe manejar errores con cuerpo de solicitud', () => {
            ...
            globalErrorHandler(error, requestWithBody, mockResponse, nextFunction);
