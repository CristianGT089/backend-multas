...
export class FineController {
    _fineService;
    constructor(_fineService) {
        this._fineService = _fineService;
    }
    /**
     * Registra una multa en la blockBlockchainFineStatuschain y sube la evidencia a IPFS.
     */
    async registerFine(req, res, next) {
        try {
     ...
     */
    async updateFineStatus(req, res, next) {
        try {
     ...
     */
    async getFineEvidence(req, res, next) {
        try {
     ...
     */
    async getFineFromSIMIT(req, res, next) {
        try {
     ...
     */
    async linkFineToSIMIT(req, res, next) {
        try {
            const { fineId } = req.params;
     ...
     */
    async getFineStatusHistory(req, res, next) {
        try {
            const { fineId } = req.params;
            // Validar datos requeridos
            if (!fineId) {
     ...
     */
    async getRecentFinesHistory(req, res, next) {
        try {
